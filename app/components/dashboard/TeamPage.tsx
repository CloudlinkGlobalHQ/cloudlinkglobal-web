...
export default function TeamPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Role legend */}
      <div className="bg-slate-50 border border-slate-200 rounded-xl p-4 flex gap-6 text-sm flex-wrap">
        {[
        ...
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-slate-100">
              {members.map(m => (
                <tr key={m.member_id} className={`hover:bg-slate-50 ${updating === m.member_id ? 'opacity-50' : ''}`}>
                  ...
                  <td className="px-5 py-3">
                    <select
                      ...
                      className="text-xs border border-slate-200 rounded-lg px-2 py-1 focus:outline-none focus:ring-2 focus:ring-green-400 bg-white"
                    >
