            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-2">
                ...
                <button onClick={() => copy(newKey)}
                  className={`shrink-0 px-3 py-2 rounded-lg text-sm font-medium transition ${copied ? 'bg-green-600 text-white' : 'bg-white border border-green-300 text-green-700 hover:bg-green-50'}`}>
                  {copied ? '✓ Copied' : 'Copy'}
                </button>
              </div>
            </div>
        ...
        <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md">
            ...
            <div className="flex justify-end gap-3 px-6 py-4 border-t border-slate-100">
              <button onClick={() => setShowCreate(false)} className="text-slate-600 hover:text-slate-800 px-4 py-2 text-sm font-medium">Cancel</button>
