        ...
        {loading ? (
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-slate-100">
              {entries.map((e: any) => (
                <tr key={e.result_id} className="hover:bg-slate-50">
                  ...
                  <td className="px-4 py-3"><span className={`px-2 py-0.5 rounded-full text-xs font-medium ${STATUS_STYLES[e.status] || 'bg-slate-100 text-slate-500'}`}>{e.status || '—'}</span></td>
